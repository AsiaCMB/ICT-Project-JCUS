...
if($submit)
{
  if($jobtitle&&$jobdescription&&$requirements&&$resume&&$expyears)
  {
  	$insert=mysql_query("INSERT INTO career (jobtitle, jobdescription, requirements, expyears, resume, useremail, resuser, resname, reslocation) SELECT '$jobtitle','$jobdescription','$requirements','$expyears','$resume','$useremail',resuser,resname,reslocation FROM restaurant WHERE useremail='$useremail'");
