...
<div class="banner">
	...
	while($rows=mysql_fetch_assoc($getquery))
	{
		...
		echo '<a href="sellerRestaurantPage.php" class="info">Read More</a>';  
	    echo	"</div>";  
		echo "</div>";
	}
	?>
	<div class="seeMore">
		<a href="sellerRestaurantPage.php">See more...</a>
	</div>
	...
	while($rows=mysql_fetch_assoc($getquery))
	{
		...
		echo "<h2>". $proname ."</h2>";  
		echo "<p>Description Goes Here</p>"; 
		echo '<a href="sellerPromotionAllPage.php" class="info">Read More</a>';  
	    echo	"</div>";  
		echo "</div>";
	}
	?>
	...
	<div class="seeMore">
		<a href="sellerPromotionAllPage.php">See more...</a>
	</div>
